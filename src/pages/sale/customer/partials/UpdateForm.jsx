...
const UpdateForm = () => {
  ...
  useEffect(() => {
    const getCustomerById = async () => {
      ...
      try {
        ...
        dispatch(fetchCustomerFailed(err?.response?.data?.errors));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/customer/${id}`, values, {
        params :{
            _method : "PATCH"
        },
        headers: {
      ...
      dispatch(updateCustomerFailed(err?.response?.data?.errors));
    }
  };
