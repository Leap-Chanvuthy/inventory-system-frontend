...
const Update = ({customer_category_id}) => {
  ...
  useEffect(() =>{
    const getCategory = async () =>{
        try {
            const response = await axios.get(`${BASE_URL}/customer-category/${customer_category_id}`);
  ...
  const handleSubmit = async (e) =>{
    ...
    setLoading(true);
    try {
        const response = await axios.patch(`${BASE_URL}/customer-category/update/${customer_category_id}` , values);
