...
import SaleInvoiceExport from "../../export/SaleInvoiceExport";
import useToken from "../../../../../hooks/useToken";

const SaleInvoiceTable = ({ filters }) => {
            ...
            {saleOrders.length > 0 ? (
              saleOrders.map((saleOrder) => (
                ...
                >
                  ...
                  <Table.Cell className="flex items-center cursor-pointer whitespace-nowrap font-medium text-gray-900 dark:text-white">
                    {/* <Link to={`/sale-order/update/${saleOrder.id}`}>
                      <FiEdit />
                    </Link> */}
                    <SaleInvoiceExport sale_id={saleOrder.id} />  
