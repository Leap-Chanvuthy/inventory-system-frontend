...
import RecoverSaleOrderTable from "./list/RecoverSaleOrderTable";

const RecoverSaleOrderList = () => {
  ...
  return (
    <div>
      ...
      <RecoverSaleOrderTable filters={filters} />
    </div>
  );
};

export default RecoverSaleOrderList;
