...
import { TextInput, Label, Button, Spinner, Select, Modal } from "flowbite-react";
import { useState } from "react";
import { useDispatch, useSelector } from "react-redux";
import axios from "axios";
import { BASE_URL } from "../../../../../components/const/constant";
    ...
    <div>
      ...
      <form onSubmit={exportSupplier}>
        ...
        <div className=" grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-3">
          <div>
            <div className="mb-2 block">
              <Label className="font-semibold" value="Location" />
            </div>
            <TextInput
              id="location"
              type="text"
          ...
          <div>
            <div className="mb-2 block">
              <Label className="font-semibold" value="Bank Name" />
            </div>
            <TextInput
              id="bank_name"
              type="text"
          ...
          <div className="w-full">
            <Label className="font-semibold" htmlFor="supplier_status" value="Supplier Status" />
            <Select
              id="supplier_status"
              type="text"
              placeholder="Website"
          ...
          <div className="w-full">
            <Label className="font-semibold" htmlFor="supplier_category" value="Supplier Category" />
            <Select
              id="supplier_category"
              type="text"
              placeholder="Website"
          ...
          <div>
            <div className="mb-2 block">
              <Label className="font-semibold" value="Contract Length" />
            </div>
            <TextInput
              id="contract_length"
              type="text"
          ...
          <div>
            <div className="mb-2 block">
              <Label className="font-semibold" value="Discount Term" />
            </div>
            <TextInput
              id="discount_term"
              type="text"
          ...
          <div>
            <div className="mb-2 block">
              <Label className="font-semibold" value="Payment Term" />
            </div>
            <TextInput
              id="payment_term"
              type="text"
