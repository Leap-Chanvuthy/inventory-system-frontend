...
import { fetchProductsStart , fetchProductsFailure , fetchProductsSuccess , deleteProductStart , deleteProductFailure , deleteProductSuccess } from "../../../../../redux/slices/productSlice";
...
const Product = ({ filters }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      dispatch(
        deleteProductFailure(err.message || "Error deleting data from the server.")
      );
    }
  };
              ...
              products.map((product) => (
                ...
                >
                  ...
                  <Table.Cell className="flex items-center cursor-pointer gap-3 whitespace-nowrap font-medium text-gray-900 dark:text-white">
                    <Link to={`/product/update/${product.id}`}><FiEdit /></Link>
                    <MdDelete
