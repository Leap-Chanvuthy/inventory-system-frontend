...
const UpdateForm = () => {
  ...
  // Update initial values when useEffect run
  useEffect(() => {
    if (products) {
      setValues({
        image: [],
        ...
        package_size: products?.package_size,
        status: products?.status,
        warehouse_location: products?.warehouse_location,
        description: products?.description,
        staging_date: products?.staging_date,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(updateProductFailure(error?.response?.data?.errors));
    }
  };
