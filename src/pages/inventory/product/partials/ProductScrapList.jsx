...
import Create from "./product-scrap/Create";
import ProductScrapTable from "./list/ProductScrapTable";

const ProductScrapList = () => {
  ...
  return (
    <div>
      <div>
        ...
        <Partial title="Products Scrap" link="list" />
      ...
      <ProductScrapTable filters={filters} />
...
export default ProductScrapList;
